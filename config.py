...
# X.AI Models
XAI_MODEL = "grok-3"  # Fallback to grok-2 if needed in code
...
CHUNK_SIZE = 8192 # Increased for larger context windows
BATCH_SIZE = 10   # Increased batch size

# Concurrency Settings
MAX_WORKERS = 50  # High concurrency for VPS
API_TIMEOUT = 120
...
# Local Indexing (Disable for high concurrency to avoid JSON corruption)
